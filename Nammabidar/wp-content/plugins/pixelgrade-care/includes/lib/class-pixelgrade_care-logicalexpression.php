...
/**
 *
 * A class to handle logical expression for config conditions.
 *
 ...
 */
class PixelgradeCare_LogicalExpression {
	 ...
	 * @var array
	 */
	protected static $all_operators = [
	 ...
	 * @var array
	 */
	protected static $unary_operators = [
	 ...
	 * @var array
	 */
	protected static $binary_operators = [
		'equal', 'not_equal',
		'less', 'less_or_equal', 'greater', 'greater_or_equal',
		'begins_with', 'not_begins_with', 'contains', 'not_contains', 'ends_with', 'not_ends_with',
	];
	 ...
	 * @var array
	 */
	protected static $ternary_operators = [
		'between', 'not_between',
	];
	...
	public static function evaluate( $left, $operator, $right = null ) {
		...
		return (bool) call_user_func( [ __CLASS__, 'evaluate_' . $operator ], $left, $right );
	}
