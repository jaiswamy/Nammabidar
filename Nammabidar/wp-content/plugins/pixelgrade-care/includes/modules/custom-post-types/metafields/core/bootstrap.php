...
PixelgradeCare_MetafieldsCore::require_all( $interfacepath );

$classpath = $basepath . 'classes' . DIRECTORY_SEPARATOR;
PixelgradeCare_MetafieldsCore::require_all( $classpath );

// load callbacks

$callbackpath = $basepath . 'callbacks' . DIRECTORY_SEPARATOR;
PixelgradeCare_MetafieldsCore::require_all( $callbackpath );
