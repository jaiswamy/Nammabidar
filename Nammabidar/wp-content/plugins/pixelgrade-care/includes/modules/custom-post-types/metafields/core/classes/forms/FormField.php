 ...
 */
class PixelgradeCare_MetafieldsFormFieldImpl extends PixelgradeCare_MetafieldsHTMLElementImpl implements PixelgradeCare_MetafieldsFormField {
	...
	function render() {
		...
		$template_paths = array_reverse( $form->getmeta( 'template-paths', [] ) );
