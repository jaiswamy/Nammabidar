 ...
 */
class PixelgradeCare_MetafieldsFormImpl extends PixelgradeCare_MetafieldsHTMLElementImpl implements PixelgradeCare_MetafieldsForm {
	...
	protected function configure( $config = null ) {
		...
		$this->autocomplete = PixelgradeCare_MetafieldsCore::instance( 'PixelgradeCare_MetafieldsMeta', [] );

		// setup fields
		$this->fields = PixelgradeCare_MetafieldsCore::instance( 'PixelgradeCare_MetafieldsMeta', $config['fields'] );
		unset( $config['fields'] );
	...
	function field( $fieldname, $fieldconfig = null ) {
		...
		return PixelgradeCare_MetafieldsCore::instance( 'PixelgradeCare_MetafieldsFormField', $fieldconfig )
		                                    ->setmeta( 'form', $this )
	...
	/** @var PixelgradeCare_MetafieldsMeta autocomplete */
	...
	function fieldtemplate( $templatepath, $conf = [] ) {
		$config = PixelgradeCare_MetafieldsCore::instance( 'PixelgradeCare_MetafieldsMeta', $conf );
	...
	/**
	 * @param string template path
	 * @param PixelgradeCare_MetafieldsMeta configuration
	 *
	 * @return string
	 */
	protected function fieldtemplate_render( $_template_path, PixelgradeCare_MetafieldsMeta $conf ) {
