 ...
 */
class PixelgradeCare_MetafieldsHTMLElementImpl extends PixelgradeCare_MetafieldsHTMLTagImpl implements PixelgradeCare_MetafieldsHTMLElement {
	...
	/**
	 * @return PixelgradeCare_MetafieldsMeta
	 */
	function meta() {
		return $this->meta;
	}
